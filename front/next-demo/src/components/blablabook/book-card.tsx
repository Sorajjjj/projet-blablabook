...
export default function BookCard({ title, author, imagePath, bgColor }: BookCardProps) {
  return (
    <Card className="w-70 mt-8 overflow-hidden border-none shadow-sm bg-white rounded-xl group cursor-pointer">
      ...
      <div className={`${bgColor} p-2 flex justify-center items-center h-55 transition-colors`}>
        <Image
          src={imagePath} 
          alt="Cover" 
          width={144} 
      ...
      <CardFooter className="flex justify-center pb-4 pt-0">
        <Link href="#" className="text-blabla-orange text-sm font-bold hover:underline">
          Voir plus
        </Link>
      </CardFooter>
    </Card>
