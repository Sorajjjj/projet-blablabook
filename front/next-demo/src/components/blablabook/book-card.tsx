...
export default function BookCard({
  ...
  bookId,
  imageUrl,
  //   Definir couleur taupe par défaut
  bgColor = "bg-blabla-taupe",
}: BookCardProps) {
  ...
  return (
    <Card className="w-[145px] h-[260px] md:w-70 md:h-83 overflow-hidden border-none shadow-sm bg-white rounded-xl group flex flex-col">
      {/* Image Zone */}
      {/* Replace bg-blabla-taupe */}
      <div
        className={`${bgColor} p-2 md:p-4 flex justify-center items-center h-[165px] md:h-64 transition-colors relative`}
      >
